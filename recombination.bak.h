...
int finithermo(double taumin,double taumax,double dlntau0,int nstepsan[],double tausann[]) // return taurend    do this 
{
	double tau01;
	double rxsan[2];
	double tb[nthermo];
...
//	fp1=fopen("recomb.d","w");
   ...
   tb[1]=tcmb/a0;																						// Assume that any entropy generation occurs before tauminn.
